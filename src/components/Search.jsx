...
const Search = () => {
    return (
        <div className="search flex jus-cent" style={{ backgroundImage: `url(${bgImage})`, minHeight: '8.625rem', color: 'grey', borderRadius: '10px' }}>
            <div className='flex algn-cen' style={{ position: 'relative', width: '90%' }}>
                <WorkOutlineIcon style={{ position: 'absolute', left: '.8rem' }} />
                <input type='text' style={{ height: '3.438rem', width: '100%' }} placeholder='Title, companies, experti...' />
